...
class CustomDatePicker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CupertinoCalendarPickerButton(
      ...
      formatter: formatter ?? (dateTime) => DateFormat('MMMM yyyy').format(dateTime),
      monthPickerDecoration: CalendarMonthPickerDecoration(
        defaultDayStyle: CalendarMonthPickerDefaultDayStyle(
          textStyle: theme.textTheme.bodyMedium!.copyWith(color: Theme.of(context).colorScheme.onSurface),
        ),
        currentDayStyle: CalendarMonthPickerCurrentDayStyle(
          textStyle: theme.textTheme.bodyMedium!.copyWith(color: Theme.of(context).colorScheme.secondary),
        ),
      ),
      buttonDecoration: PickerButtonDecoration.withDynamicColor(
        context,
        textStyle:
            buttonTextStyle ?? theme.textTheme.bodySmall!.copyWith(color: Theme.of(context).colorScheme.onSurface),
        backgroundColor: CupertinoDynamicColor(
          ...
          highContrastColor: Theme.of(context).colorScheme.onSurface.withAlpha(00),
          darkElevatedColor: Theme.of(context).colorScheme.onSurface.withAlpha(00),
          darkHighContrastColor: Theme.of(context).colorScheme.onSurface.withAlpha(00),
          elevatedColor: Theme.of(context).colorScheme.onSurface.withAlpha(00),
          highContrastElevatedColor: Theme.of(context).colorScheme.onSurface.withAlpha(00),
          darkHighContrastElevatedColor: Theme.of(context).colorScheme.onSurface.withAlpha(00),
        ),
      ),
    );
  }
