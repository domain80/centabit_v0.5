...
class _Initial implements CategoryFormState {
  const _Initial();
...
class _Loading implements CategoryFormState {
  const _Loading();
...
class _Success implements CategoryFormState {
  const _Success();
...
@override
String toString() {
  return 'CategoryFormState.success()';
}
...
class _Error implements CategoryFormState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $CategoryFormStateCopyWith<$Res> {
