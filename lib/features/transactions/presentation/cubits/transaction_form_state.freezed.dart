...
class _Initial implements TransactionFormState {
  const _Initial();
...
class _Loading implements TransactionFormState {
  const _Loading();
...
class _Success implements TransactionFormState {
  const _Success();
...
@override
String toString() {
  return 'TransactionFormState.success()';
}
...
class _Error implements TransactionFormState {
...
@override
String toString() {
  return 'TransactionFormState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $TransactionFormStateCopyWith<$Res> {
